...
$CTOOLS/download-pip.sh "$LISTS_DIR/${tag}-pip_packages.list" "$DATA_DIR/pkg/ubuntu/ansible_pkg"
$CTOOLS/download-files.sh "$LISTS_DIR/deb_packages.list" "$DATA_DIR/pkg/ubuntu/ansible_pkg"
