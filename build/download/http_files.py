...
def download(data_list, dst_dir, check, progress=None, workers=None):
    """
    ...
    if progress is not None:
        ...
        progress.value = target_count - len(missing_files)
...
def run_cli():
    ...
    progress = base.init_progress('http files', True)
