...
def test_check_mode_images_not_pulled(drop_test_images, init_cli_check, test_image_list):
    parse_check_output("False", test_image_list, init_cli_check)

def test_pull_images_from_mirror(init_cli_with_registry_mirror, test_image_list, init_cli_check):
    parse_check_output("True", test_image_list, init_cli_check)

def test_pull_images(drop_test_images, init_cli, test_image_list, init_cli_check):
    parse_check_output("True", test_image_list, init_cli_check)

def test_cleanup_images(drop_test_images):
