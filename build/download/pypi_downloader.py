...
class PyPiDownloader(command_downloader.CommandDownloader):
    ...
    def _download_item(self, item):
        ...
        :param package_name: name of pypi package (possibly with version specification)
        :param dst_dir: where to save package
        """
