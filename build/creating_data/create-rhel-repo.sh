...
yumdownloader --resolve --destdir="${OUTDIR}" docker-ce-18.09.5 container-selinux docker-ce-cli containerd.io nfs-utils python-jsonpointer python-docker-py python-docker-pycreds python-ipaddress python-websocket-client
