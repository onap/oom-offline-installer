...
help () {
    ...
    echo "usage: create_repo.sh [-d|--destination-repository output directory] [-c|--clonned-directory input directory]"
    echo "-h --help: Show this help"
    echo "-d --destination-repository: set path where will be stored RPM packages"
    echo "-c --clonned-directory: set path where is stored this script and docker-entrypoint script (offline-installer/build directory)"
